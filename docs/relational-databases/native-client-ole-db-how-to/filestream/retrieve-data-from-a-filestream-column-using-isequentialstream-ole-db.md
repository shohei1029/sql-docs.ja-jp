---
description: SQL Server Native Client で ISequentialStream を使用して FILESTREAM 列からデータを取得する (OLE DB)
title: ISequentialStream を使用した FILESTREAM (OLE DB)
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
