---
description: IRowsetFastUpload SQL Server Native Client (OLE DB) を使用して FILESTREAM 列にデータを送信する
title: データ FILESTREAM、IRowsetFastUpload (OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
