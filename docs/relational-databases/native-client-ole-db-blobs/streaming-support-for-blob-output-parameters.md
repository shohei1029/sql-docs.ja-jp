---
description: SQL Server Native Client での BLOB 出力パラメーターのストリーミングサポート
title: BLOB 出力パラメーターのストリーミングサポート (Native Client OLE DB プロバイダー)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "104749472"
---
# <a name="streaming-support-for-blob-output-parameters-in-sql-server-native-client"></a>SQL Server Native Client での BLOB 出力パラメーターのストリーミングサポート
