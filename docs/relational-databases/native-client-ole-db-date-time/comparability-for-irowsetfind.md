---
description: 比較 for IRowsetFind の SQL Server Native Client
...
ms.locfileid: "104748422"
---
# <a name="sql-server-native-client-comparability-for-irowsetfind"></a>比較 for IRowsetFind の SQL Server Native Client
