---
description: SQL Server Native Client (プロパティ) でのパラメーターの型のサポートの OLE DB Table-Valued
title: パラメーターの型の OLE DB Table-Valued (プロパティ)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "104753472"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-properties"></a>SQL Server Native Client (プロパティ) でのパラメーターの型のサポートの OLE DB Table-Valued
