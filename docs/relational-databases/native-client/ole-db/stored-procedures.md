---
description: SQL Server Native Client のストアドプロシージャ
...
ms.locfileid: "104755892"
---
# <a name="stored-procedures-in-sql-server-native-client"></a>SQL Server Native Client のストアドプロシージャ
