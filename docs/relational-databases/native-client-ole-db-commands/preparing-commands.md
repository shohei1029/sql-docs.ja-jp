---
description: SQL Server Native Client でのコマンドの準備
title: コマンドの準備 (Native Client OLE DB プロバイダー)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "104749012"
---
# <a name="preparing-commands-in-sql-server-native-client"></a>SQL Server Native Client でのコマンドの準備
