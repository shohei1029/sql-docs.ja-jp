---
title: 保存されるデータ ソース オブジェクト (OLE DB ドライバー)
description: これらの例では、OLE DB Driver for SQL Server の IPersistFile インターフェイスによる保存されたデータ ソース オブジェクトのサポートについて説明します。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  OLE DB Driver for SQL Server は、**IPersistFile** インターフェイスを通じて、保存されたデータ ソース オブジェクトをサポートしています。  
