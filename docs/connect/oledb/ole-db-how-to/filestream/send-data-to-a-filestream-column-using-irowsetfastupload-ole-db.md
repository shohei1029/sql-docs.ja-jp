...
description: この例では、OLE DB Driver for SQL Server で IRowsetFastUpload インターフェイスを使用して 4 MB から 4 GB のデータを FILESTREAM 列に送信する方法について説明します。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
