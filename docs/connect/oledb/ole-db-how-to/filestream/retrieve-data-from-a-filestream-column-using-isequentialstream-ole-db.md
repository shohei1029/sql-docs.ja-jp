...
description: OLE DB Driver for SQL Server で ICommandText インターフェイス内にある ISequentialStream インターフェイスを使用して Filestream 列からレコードを取得する方法について説明します。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../../includes/driver_oledb_download.md)]
 ...
 Filestream 機能の詳細については、「[FILESTREAM サポート](../../../oledb/features/filestream-support.md)」を参照してください。  
